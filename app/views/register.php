...
use Illuminate\Support\Facades\URL;
 ...
 echo $panelInit->settingsArray['siteTitle'] . " | " . $panelInit->language['registerNewAccount']; ?></title>
    ...
    <body class="bg-black rtlPage" ng-app="schoex" ng-controller="registeration">
