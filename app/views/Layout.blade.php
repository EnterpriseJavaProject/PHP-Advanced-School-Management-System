...
<html>
 ...
 echo $panelInit->settingsArray['siteTitle'] . " | " . $panelInit->language['dashboard'] ; ?></title>
        <base href="<?php echo Illuminate\Support\Facades\URL::to('/'); ?>/" />
    ...
    <body class="skin-<?php echo $panelInit->settingsArray['layoutColor']; ?> fixed" ng-app="schoex" ng-controller="mainController">
        <header class="header">
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-right">
                    <ul class="nav navbar-nav">
                            ...
                            <a href="/school/#/admins"><span data-hover="About">Login Details</span></a>
                            </li>
                        ...
                        <li class="dropdown user user-menu">
                            <a href="<?php echo Illuminate\Support\Facades\URL::to('/logout'); ?>" onclick="if (!confirm('Are you sure you want to log out')) return false">
        ...
        <script src="{{URL::to('/')}}/assets/js/schoex.js" type="text/javascript"></script>
    </body>
</html>