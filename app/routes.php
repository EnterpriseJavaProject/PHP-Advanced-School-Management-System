...
Route::get('/api/csrf', function() {
	...
	Route::get('/login','LoginController@loginFirst');
	...
	// LOGIN DETAILS
	Route::get('/loginDetails','LoginController@loginDetails');
	Route::get('/viewLoginDetails','LoginController@viewLoginDetails');
...
Route::group(array('prefix'=>'/','before'=>'auth|api.csrf'),function(){
	...
	Route::post('/admins/{id}','AdminsController@edit');
		...
		Route::get('/hr/listAll','HRController@listAll');
		Route::delete('/hr/{id}','HRController@delete');
		Route::post('/hr','HRController@create');
		Route::get('/hr/{id}','HRController@fetch');
		Route::post('/hr/{id}','HRController@edit');
